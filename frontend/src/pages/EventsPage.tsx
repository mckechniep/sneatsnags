              ...
              <div style={{
                ...
                {[
                  ...
                  <button
                    ...
                    onMouseEnter={(e: React.MouseEvent<HTMLButtonElement>) => {
                      e.currentTarget.style.background = 'linear-gradient(135deg, #1D3557 0%, #457B9D 100%)';
                      e.currentTarget.style.color = 'white';
                      e.currentTarget.style.transform = 'translateY(-1px)';
                      e.currentTarget.style.boxShadow = '0 4px 12px rgba(29, 53, 87, 0.3)';
                    }}
                    onMouseLeave={(e: React.MouseEvent<HTMLButtonElement>) => {
                  ...
                  <div style={{ marginBottom: '20px' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                      <div style={{ 
                        ...
                        <Calendar style={{ width: '16px', height: '16px', marginRight: '12px', color: '#1D3557' }} />
                      ...
                      <div style={{ 
                        ...
                        <MapPin style={{ width: '16px', height: '16px', marginRight: '12px', color: '#1D3557' }} />
                        <span style={{ 
                          overflow: 'hidden',
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <Calendar style={{ width: '48px', height: '48px', color: '#555555' }} />
              </div>
              <h3 style={{
                fontSize: '28px',
                fontWeight: '800',
